/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c767f50abbee62935afc95316f9bd41c)
...
declare namespace Cloudflare {
	...
	interface Env {
		CACHE: KVNamespace;
		DB: D1Database;
		LLMOPS_GATEWAY_URL: "https://gateway.llmops.build/v1";
		SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
		SDLC_AGENT_WORKFLOW: Workflow<Parameters<import("./src/index").SdlcAgentWorkflow['run']>[0]['payload']>;
		REVISION_WORKFLOW: Workflow<Parameters<import("./src/index").RevisionWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLMOPS_GATEWAY_URL">> {}
}
declare module "*.md" {
	const value: string;
